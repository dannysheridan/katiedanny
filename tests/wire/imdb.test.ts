...
import * as ThomasTestOrg2Api from "../../src/api/index";
import { ThomasTestOrg2ApiClient } from "../../src/Client";
import { mockServerPool } from "../mock-server/MockServerPool";

describe("ImdbClient", () => {
    test("createMovie", async () => {
        const server = mockServerPool.createServer();
        const client = new ThomasTestOrg2ApiClient({ maxRetries: 0, environment: server.baseUrl });
    ...
    test("getMovie (2)", async () => {
        ...
        }).rejects.toThrow(ThomasTestOrg2Api.MovieDoesNotExistError);
    });
});
