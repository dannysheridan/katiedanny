...
import * as ThomasTestOrg2Api from "../../../index.js";
...
export class ImdbClient {
     ...
     *
     * @param {ThomasTestOrg2Api.CreateMovieRequest} request
    ...
    ): core.HttpResponsePromise<ThomasTestOrg2Api.MovieId> {
    ...
    private async __createMovie(
        request: ThomasTestOrg2Api.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<ThomasTestOrg2Api.MovieId>> {
        ...
        if (_response.ok) {
            return { data: _response.body as ThomasTestOrg2Api.MovieId, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            throw new errors.ThomasTestOrg2ApiError({
     ...
     *
     * @param {ThomasTestOrg2Api.MovieId} id
     * @param {ImdbClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ThomasTestOrg2Api.MovieDoesNotExistError}
     *
     * @example
    ...
    public getMovie(
        ...
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<ThomasTestOrg2Api.Movie> {
    ...
    private async __getMovie(
        id: ThomasTestOrg2Api.MovieId,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<ThomasTestOrg2Api.Movie>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as ThomasTestOrg2Api.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new ThomasTestOrg2Api.MovieDoesNotExistError(
                        _response.error.body as ThomasTestOrg2Api.MovieId,
